...
export interface ApiCardDetailCardDetail extends Struct.CollectionTypeSchema {
  collectionName: 'card_details';
  info: {
    displayName: 'card_detail';
...
export interface ApiEmailNotifyEmailNotify extends Struct.CollectionTypeSchema {
...
export interface ApiHelpAndSupportHelpAndSupport
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['contact', 'career', 'event', 'other']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
...
export interface ApiNotificationManagementNotificationManagement
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::notification-management.notification-management'
    > &
      Schema.Attribute.Private;
...
export interface ApiVarientVarient extends Struct.CollectionTypeSchema {
...
export interface ApiWebNotificationWebNotification
  extends Struct.CollectionTypeSchema {
  collectionName: 'web_notifications';
  info: {
    displayName: 'web_notification';
    pluralName: 'web-notifications';
    singularName: 'web-notification';
  };
  options: {
    draftAndPublish: true;
  };
